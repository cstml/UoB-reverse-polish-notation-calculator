...
"""
An error carrier helper class. It is created by the model class and passed by
the controller to the view which then uses its attached information to create
its view.
"""
...
class Error:
    ...
    def __init__ (self, t, m = Error_Type.DEFAULTV):
        """
        Default type: 
            e_message = Error_Type.DEFAULTV
        """
        self.e_type = t
        self.e_message = m
